...
router.get("/", optionalAuthMiddleware_1.default, tournaments_1.getAllTournaments);
router.get("/:id/lobby", optionalAuthMiddleware_1.default, tournaments_1.getTournamentLobby);
router.post("/weekly/current", tournaments_1.getLatestFeaturedTournament);
...
router.get('/swiss/results', tournaments_1.getLatestSwissTournamentWinners);
