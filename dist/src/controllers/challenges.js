...
exports.getOpenChallenges = exports.cancelChallenge = exports.settleCashChallenge = exports.acceptChallenge = exports.getChallenges = exports.createChallenge = void 0;
const db_1 = __importDefault(require("../config/db"));
const gameFunctions_1 = require("../utils/gameFunctions");
const __1 = require("..");
const express_async_handler_1 = __importDefault(require("express-async-handler"));
const createChallenge = (0, express_async_handler_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    var _a, _b;
    const { opponent_id, match_type, challenge_mode, 
    // Game configuration
    winPoints, numPlayers, includeSixes, includeAces, 
    // Only required for stake games
    stake, } = req.body;
    // =====================================================
    // 1. AUTHENTICATED USER
    // =====================================================
    console.log("opponent_id: ", opponent_id, "match_type: ", match_type, "challenge_mode: ", challenge_mode);
    console.log("win points: ", winPoints, "numplayers: ", numPlayers, "include Sixes: ", includeSixes, "include Aces: ", includeAces);
    console.log("stake: ", stake);
    const creator_id = (_a = req.user) === null || _a === void 0 ? void 0 : _a.userId;
    if (!creator_id) {
        res.status(401).json({
            success: false,
    ...
    try {
        ...
        // ===================================================
        if (opponent_id) {
            const opponent = yield (0, db_1.default) `
          SELECT id
          FROM users
        ...
        // ===================================================
        if (challenge_mode === "direct" && opponent_id) {
            const existingChallenge = yield (0, db_1.default) `
          SELECT id
          FROM challenges
      ...
      `;
        ...
        const transactionQueries = [
          ...
          new_game AS (
            ...
            SELECT
              ...
              ${creator_id},
              ${numPlayers},
              ${includeSixes !== null && includeSixes !== void 0 ? includeSixes : false},
              ${includeAces !== null && includeAces !== void 0 ? includeAces : false},
              ${winPoints},
              'waiting'
        ...
        const [transactionResult] = yield db_1.default.transaction(transactionQueries);
        // ===================================================
        ...
        if (challenge && challenge.id) {
            ...
            yield __1.expiredChallenges.scheduleExpiredChallenge(challenge.id, Math.max(delayMs, 0));
        }
        // ===================================================
        ...
        SELECT
          ...
          ${(_b = row.player) === null || _b === void 0 ? void 0 : _b.id},
      ...
      `;
        ...
        // ===================================================
        const game = Object.assign(Object.assign({}, row), { players: row.player ? [row.player] : [], cards: gameCards, challenge: row.challenge || null, isStakeGame: match_type === "stake" });
        delete game.player;
        // ===================================================
        // 16. MIXPANEL
        // ===================================================
        __1.mixpanel.track("Challenge Created", Object.assign({ distinct_id: creator_id, challenge_id: challenge === null || challenge === void 0 ? void 0 : challenge.id, game_code: gameCode, match_type,
            challenge_mode, num_players: numPlayers, win_points: winPoints }, (match_type === "stake" && {
            stake: numericStake,
        ...
        if ((error === null || error === void 0 ? void 0 : error.message) === "INSUFFICIENT_BALANCE" ||
            (error === null || error === void 0 ? void 0 : error.code) === "INSUFFICIENT_BALANCE") {
            res.status(400).json({
                success: false,
                message: "Insufficient available balance to cover the stake",
            });
...
exports.getOpenChallenges = getOpenChallenges;
const getChallenges = (0, express_async_handler_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { user_id } = req.body;
    try {
        const challenges = yield (0, db_1.default) `
...
const acceptChallenge = (0, express_async_handler_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    ...
    const challengeStake = yield (0, db_1.default) `select stake from challenges where id = ${challenge_id}`;
    try {
        /*
         * ------------------------------------------------
        ...
        if (!transactionResult || transactionResult.length === 0) {
             ...
             */
            const challengeCheck = yield (0, db_1.default) `
          SELECT
            id,
            creator_id,
            status,
        ...
        `;
            ...
            if (existingChallenge.expires_at &&
        ...
        const game = yield (0, gameFunctions_1.getGameByCode)(gameCode);
        if (!game) {
            /*
        ...
        yield __1.expiredChallenges.cancelExpiredChallenge(challenge.id);
        // --------------------------------------------------
        // 6. UPDATE GAME STATE
        // --------------------------------------------------
         ...
         */
        const alreadyExists = game.players.some((player) => { var _a; return Number(player.user_id || ((_a = player.user) === null || _a === void 0 ? void 0 : _a.id)) === Number(user_id); });
        if (!alreadyExists) {
            /*
             ...
             */
            const [fullPlayer] = yield (0, db_1.default) `
          SELECT
            gp.id,
            gp.game_id,
            gp.user_id,
        ...
        // --------------------------------------------------
        __1.serverSocket.to(gameCode).emit("gameData", game);
        // --------------------------------------------------
        // 9. MIXPANEL
        // --------------------------------------------------
        __1.mixpanel.track("Cash Challenge Accepted", {
            distinct_id: user_id,
...
const cancelChallenge = (0, express_async_handler_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    const { challenge_id } = req.body;
    const user_id = (_a = req.user) === null || _a === void 0 ? void 0 : _a.userId;
    // --------------------------------------------------
    ...
    try {
         ...
         */
        const [transactionResult] = yield db_1.default.transaction([
            (0, db_1.default) `
          WITH target_challenge AS (
        ...
        // --------------------------------------------------
        if (!transactionResult || transactionResult.length === 0) {
            const challenge = yield (0, db_1.default) `
          SELECT
            id,
            creator_id,
            game_id,
        ...
        `;
            ...
            if (existingChallenge.status === "accepted") {
                res.status(400).json({
                    success: false,
                    message: "You cannot cancel a challenge that has already been accepted",
                });
                return;
            }
            // Already in progress
        ...
        // --------------------------------------------------
        const result = transactionResult[0];
        console.log(`Challenge ${result.challenge_id} cancelled. ` +
         ...
         */
        if (__1.expiredChallenges) {
            yield __1.expiredChallenges.cancelExpiredChallenge(Number(result.challenge_id));
        }
        // --------------------------------------------------
        ...
        // 6. MIXPANEL
        // --------------------------------------------------
        __1.mixpanel.track("Cash Challenge Cancelled", {
            distinct_id: user_id,
...
const settleCashChallenge = (0, express_async_handler_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
