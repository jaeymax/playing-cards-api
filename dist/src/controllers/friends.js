...
const getFriendshipStatus = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const userExists = yield (0, db_1.default) `
      SELECT id
      FROM users
      WHERE id = ${friendId}
      LIMIT 1
    `;
         ...
         * friendId → userId
         */
        const friendship = yield (0, db_1.default) `
      SELECT
        id,
        requester_id,
        addressee_id,
...
const sendFriendRequest = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    `;
        ...
        const existingRelationship = yield (0, db_1.default) `
      SELECT
        id,
        requester_id,
        addressee_id,
    ...
    `;
        if (existingRelationship.length > 0) {
            ...
            if (relationship.status === "declined" ||
                ...
                const updatedRelationship = yield (0, db_1.default) `
          UPDATE friendships
          SET
            requester_id = ${requesterId},
        ...
        const newFriendship = yield (0, db_1.default) `
...
const acceptFriendRequest = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
         ...
         */
        const updatedFriendship = yield (0, db_1.default) `
      UPDATE friendships
      SET
        status = 'accepted',
        responded_at = NOW(),
    ...
    `;
        ...
        if (updatedFriendship.length === 0) {
            ...
            const existingFriendship = yield (0, db_1.default) `
        SELECT
          id,
          requester_id,
          addressee_id,
...
const removeFriend = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
         ...
         */
        const removedFriendship = yield (0, db_1.default) `
...
const searchUsers = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    `;
         ...
         */
        const totalResult = yield (0, db_1.default) `
